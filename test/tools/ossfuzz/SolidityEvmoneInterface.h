...
{
public:
	SolidityCompilationFramework(langutil::EVMVersion _evmVersion = {});

	Json::Value methodIdentifiers()
	{
...
struct EvmoneUtility
{
	...
	/// @returns the result returned by the Evm host on compiling,
	/// deploying, and executing @param _methodName belonging to
	/// @param _contractName in @param _sourceCode. Optimisation
